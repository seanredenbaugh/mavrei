...
<head>
  ...
  <link rel="stylesheet" href="<?= e(base_url('assets/css/property.css')) ?>">
</head>
<body class="detail-page">
  <header class="detail-header"><a href="<?= e(base_url()) ?>">← Back to map</a><img src="<?= e(base_url('assets/img/mavreilogo.png')) ?>" alt="Maverick Real Estate Investments"><?php if (is_admin()): ?><a href="<?= e(base_url('admin/property.php?id=' . $property['id'])) ?>">Edit property</a><?php else: ?><span></span><?php endif; ?></header>
